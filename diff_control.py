...
class Diff_controller(Control):
    def __init__(self, ip: str, port: int):
        super().__init__()
        self.pub = Publisher(port=port, scope=Scope.BROADCAST)
        ...
        while True:
            ...
            if pygame.key.get_focused():
                ...
                if key[pygame.K_UP]:
                    ...
                    self.dict_send["command"] = "backward"
                elif key[pygame.K_LEFT]:
                    self.dict_send["command"] = "left"
                elif key[pygame.K_RIGHT]:
                    self.dict_send["command"] = "right"
                else:
                    self.dict_send["command"] = "stop"
